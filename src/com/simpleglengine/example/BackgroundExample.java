...
public class BackgroundExample extends GLActivity {
	private Texture mTexture;
	private TextureRegion mSpriteTextureRegion;
	
	public BackgroundExample() {
		// Config
		this.name = "Set a background";
	}
	...
	public Scene onLoadScene() {
	    ...
	    Sprite sprite = new Sprite(mSpriteTextureRegion, 0, 0) {
	    	...
	    	public boolean onTouch(MotionEvent event) {
	    		if(event.getAction() == MotionEvent.ACTION_DOWN) {
	    			Toast.makeText(BackgroundExample.this, "Good Game", Toast.LENGTH_SHORT).show();
	    			return true;
	    		}
	    		return false;
	    	}
	    ...
	    // Set background
	    scene.setBackground(new ColorBackground(0.2f, 0.2f, 0.2f, 1.0f));
	    // Also available TextureBackground & AutoParallaxBackground (you can attach others entities on).
